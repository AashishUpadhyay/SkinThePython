...
def test7():
    ...
    people = [
        ["pjovtkytubbouq"],
        ["baayobms"],
        ["baayobms", "pjovtkytubbouq"],
        ["chpzrslbtd"],
        [],
        ["yomqrposuurmvisx"],
        ["uighcqpiteg"],
        [],
        ["gkgtfxpvxnxlbhxu", "yomqrposuurmvisx", "uighcqpiteg"],
        [],
        ["pjovtkytubbouq", "uighcqpiteg"],
        ["yomqrposuurmvisx"],
        [],
        [],
        [],
        ["pjovtkytubbouq"],
        ["gkgtfxpvxnxlbhxu", "yomqrposuurmvisx", "pjovtkytubbouq", "uighcqpiteg"],
        ...
        ["gkgtfxpvxnxlbhxu"],
        ["yomqrposuurmvisx"],
        ["pjovtkytubbouq", "chpzrslbtd"],
        ["uighcqpiteg"],
        ["pjovtkytubbouq"],
        ["yomqrposuurmvisx", "pjovtkytubbouq", "uighcqpiteg"],
        [],
        ["pjovtkytubbouq"],
        [],
        ["chpzrslbtd"],
...
def test8():
    ...
    people = [
        ["eqjruombtk"],
        ["euhrjnpudcvbsjj", "kvpyhqsgoskh"],
        ["wav", "eqjruombtk", "kvpyhqsgoskh"],
        [],
        ["cwhunthtwmjfqtz"],
        [],
        ["cwhunthtwmjfqtz"],
        ["cwhunthtwmjfqtz"],
        ["euhrjnpudcvbsjj"],
        ["wav", "euhrjnpudcvbsjj", "wtvehl"],
        ["eqjruombtk"],
        [],
        ["vpntuztaexauy"],
        [],
        ["hobqgx", "euhrjnpudcvbsjj", "vpntuztaexauy", "xyhh"],
        ["wav", "eqjruombtk", "kvpyhqsgoskh"],
        ["wav", "euhrjnpudcvbsjj"],
        ["wav", "kvpyhqsgoskh"],
        ["kvpyhqsgoskh"],
        [],
        ["wtvehl"],
        ["cwhunthtwmjfqtz", "kvpyhqsgoskh"],
        ["euhrjnpudcvbsjj", "kvpyhqsgoskh"],
        ["cwhunthtwmjfqtz", "kvpyhqsgoskh"],
        ["euhrjnpudcvbsjj", "cwhunthtwmjfqtz", "eqjruombtk"],
        ["wav", "hobqgx", "cwhunthtwmjfqtz", "vpntuztaexauy"],
        ["wav", "cwhunthtwmjfqtz"],
        ["wav", "hobqgx"],
        ["hobqgx", "kvpyhqsgoskh", "wtvehl"],
        ["euhrjnpudcvbsjj", "kvpyhqsgoskh"],
        ["euhrjnpudcvbsjj"],
        ["vpntuztaexauy"],
        ["euhrjnpudcvbsjj"],
        ["euhrjnpudcvbsjj", "cwhunthtwmjfqtz"],
        ["wav"],
        [],
        ["wav"],
        ["euhrjnpudcvbsjj"],
...
def test9():
    ...
    people = [
        ["gurg", "dvkplbbs"],
        ["xweykqj"],
        ["jzjgkjymmlsv", "ryeqispun", "gurg", "lmdghrdhqr", "sxx"],
        ["ryeqispun", "gurg"],
        ["ryeqispun", "lmdghrdhqr"],
        [],
        ["xweykqj"],
        [],
        ["gurg"],
        ["ryeqispun", "gurg", "lmdghrdhqr"],
        ["ryeqispun"],
        ["gurg", "lmdghrdhqr"],
        [],
        ["ryeqispun", "gurg", "lmdghrdhqr"],
        ...
        ["xweykqj", "sxx"],
        [],
        ["jzjgkjymmlsv", "dvkplbbs"],
        ["ryeqispun"],
        ["ryeqispun", "paiutrvmzg", "dvkplbbs"],
        [],
        ["sxx"],
        [],
        ["jzjgkjymmlsv", "xweykqj"],
        ["xweykqj"],
        ["gurg", "dvkplbbs"],
        ["lmdghrdhqr", "sxx"],
        ["gurg", "lmdghrdhqr", "dvkplbbs", "sxx"],
        ["gurg"],
        ["xweykqj"],
        [],
        [],
...
def test10():
    ...
    people = [
        ...
        ["w"],
        ["vgzp", "w"],
        ["nvkjkzxrfn", "bdfmsjlddbinqo", "edpuw"],
        ["urfys"],
        ["bdfmsjlddbinqo", "xvgkyzqpmzwcxol", "twlau"],
        ["nvkjkzxrfn", "bdfmsjlddbinqo", "vybgxpyq"],
        ["vgzp", "edpuw"],
        ["urfys", "xvgkyzqpmzwcxol"],
        ["bdfmsjlddbinqo", "w"],
        ["nvkjkzxrfn", "bdfmsjlddbinqo", "w"],
        ["bdfmsjlddbinqo", "vybgxpyq"],
        ["urfys", "bdfmsjlddbinqo"],
        ["vgzp"],
        ["nvkjkzxrfn", "xvgkyzqpmzwcxol"],
        ["nvkjkzxrfn"],
        ["vgzp", "edpuw"],
        [],
        ["bdfmsjlddbinqo"],
        ["vgzp", "nvkjkzxrfn", "xvgkyzqpmzwcxol"],
        ["vgzp", "bdfmsjlddbinqo", "edpuw", "w"],
        ["xvgkyzqpmzwcxol", "vybgxpyq", "w"],
        ["pqznypwpcv", "vybgxpyq"],
        ["vybgxpyq"],
        ["twlau"],
        ["vgzp"],
        ["vgzp", "twlau", "edpuw"],
        ["nvkjkzxrfn", "bdfmsjlddbinqo"],
        ["bdfmsjlddbinqo"],
        ["vgzp"],
        ["urfys"],
        ["nvkjkzxrfn"],
        ...
        ["xvgkyzqpmzwcxol"],
        [],
        ["nvkjkzxrfn", "xvgkyzqpmzwcxol", "vybgxpyq"],
        ["vybgxpyq"],
        ["nvkjkzxrfn"],
        ["nvkjkzxrfn", "edpuw"],
        ["vgzp"],
...
def test13():
    ...
    people = [["algorithms", "math", "java"], ["math"], ["java"], ["algorithms"]]
    assert_test(req_skills, people)
...
def test14():
    ...
    people = [
        ...
        ["i"],
        [],
        ["mvtwffgkhjrtibto", "odiwidzqw"],
        [],
        ["cjozlkyodt", "odiwidzqw"],
        ["arn"],
        [],
        [],
        ["acrsxqvus"],
